  ...
  const innerContent = (
    <>
      {isLoading ? (
        ...
        <>
          {/* Explication */}
          <div className="mb-6 bg-purple-50 border-2 border-purple-200 rounded-2xl p-4">
          ...
          {!isAdding && (
            <button
              ...
              disabled={isSaving}
              className="w-full mb-6 bg-purple-50 hover:bg-purple-100 text-purple-700 font-bold py-4 px-6 rounded-2xl transition-all flex items-center justify-center gap-2 border-2 border-purple-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Plus size={20} />
              Ajouter une StarApp
            </button>
          ...
          {isAdding && (
            <div className="mb-6 bg-white rounded-2xl border-2 border-slate-200 overflow-hidden">
              <div className="sticky top-0 bg-gradient-to-r from-purple-50 to-pink-50 px-6 py-4 border-b-2 border-slate-200 z-10">
          ...
          <div className="space-y-3">
            ...
            {apps.length === 0 ? (
              <p className="text-center text-slate-400 py-8">Aucune StarApp ajoutée pour le moment</p>
            ) : (
              apps.map(app => (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 relative shrink-0">
          ...
          <h2 className="text-2xl font-black mb-2">Administration StarApps</h2>
          <p className="text-sm text-white/80">Gérez les applications de la sélection</p>
        </div>
